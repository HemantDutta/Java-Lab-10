...
public class UpdateDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Unbounded", 1, 24)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Connection con = ConnProv.getCon();
            PreparedStatement pa = con.prepareStatement("update member set name = '"+name+"', phone = '"+phone+"', email = '"+email+"', age = '"+age+"', amount = '"+amount+"' where id = '"+id+"'");
            pa.executeUpdate();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            Connection con = ConnProv.getCon();
            PreparedStatement pa = con.prepareStatement("Delete from member where id = '"+id+"'");
            pa.executeUpdate();
